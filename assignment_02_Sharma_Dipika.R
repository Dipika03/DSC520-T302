...
## Use `setwd()` if needed
setwd("/Users/dipikasharma/R_Projects")
getwd()

## Load the file `data/tidynomicon/person.csv` to `person_df1` using `read.csv`
## Examine the structure of `person_df1` using `str()`
person_df1 <- read.csv(file = "/Users/dipikasharma/R_Projects/DSC520/data/tidynomicon/person.csv")
person_df1v1 <- read.csv(file = "/Users/dipikasharma/R_Projects/DSC520/data/tidynomicon/person.csv", stringsAsFactors = TRUE)
person_df1
str(person_df1)
str(person_df1v1)
...
person_df2 <- read.csv("/Users/dipikasharma/R_Projects/DSC520/data/tidynomicon/person.csv", stringsAsFactors = FALSE)
str(person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <- read.csv("/Users/dipikasharma/R_Projects/DSC520/data/scores.csv")
summary(scores_df)
...
excel_sheets("/Users/dipikasharma/R_Projects/DSC520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("/Users/dipikasharma/R_Projects/DSC520/data/G04ResultsDetail2004-11-02.xls", 
                                sheet = "Voter Turnout",
                                skip = 1,
                                col_names = TRUE)
...
voter_turnout_df2 <- read_excel("/Users/dipikasharma/R_Projects/DSC520/data/G04ResultsDetail2004-11-02.xls", 
                                sheet = "Voter Turnout",
                                skip = 2,
...
db <- dbConnect(RSQLite::SQLite(), dbname = "/Users/dipikasharma/R_Projects/DSC520/data/tidynomicon/example.db")
